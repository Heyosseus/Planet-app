...
function Planet() {
  ...
  return (
    <Container>
      <Image src={eachPlanet.images.overview}></Image>
      <div>
      
          <div>
            <Content>
              <Heading>{eachPlanet.name}</Heading>
              <Paragraph>{eachPlanet.content}</Paragraph>
              <Link href={eachPlanet.source}>
                Source: Wikipedia <Img src={eachPlanet.overview.source}></Img>
              </Link>
            </Content>
            <Details>
